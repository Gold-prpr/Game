...
aqua::CLinePrimitive3D::CLinePrimitive3D(void)
...
void aqua::CLinePrimitive3D::Setup(const aqua::CVector3& pointA_, const aqua::CVector3& pointB_, const aqua::CColor& color_, aqua::ALPHABLEND blend_mode_)
{
    pointA = pointA_;
    pointB = pointB_;
    color = color_;
...
void aqua::CLinePrimitive3D::Draw(void)
{
    // 非表示の時は描画しない
    if (!visible) return;
