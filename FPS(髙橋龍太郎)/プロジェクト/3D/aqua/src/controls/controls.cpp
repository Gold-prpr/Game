...
void 
aqua::mouse::
SetCursorPos(aqua::CPoint point)
{
    aqua::core::CMouse::GetInstance().SetCursorPos(point);
}
...
int 
aqua::mouse::
SetMouseFlag(int flag)
{
    return aqua::core::CMouse::GetInstance().SetMouseFlag(flag);
}
